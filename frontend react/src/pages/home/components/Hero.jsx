...
export default function Hero() {
  return (
    <>
      <section className="bg-white min-h-85 flex flex-col justify-around px-[5%] py-16 gap-8 md:flex-row">
        <div className="max-w-140 size-fit">
            ...
            <button className="text-white rounded-xl cursor-pointer bg-[#2d3748] px-8 py-3.5 mt-8  md:mt-10 md:ml-12">
              VIEW MY WORK
            </button>       
        </div>
        <div className="relative shrink-0 w-70 max-w-100 h-full">
          <img src={coche} alt="" className="block w-full object-cover" />
        </div>
      </section>
    </>
  )
